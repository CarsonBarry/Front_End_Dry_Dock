...
export default function App() {
  ...
  <div id="drydockframe" class="">
    <div class="drydockpanel flex-jS">    
      <button class="drydockbutton" onClick={splashToSidebar}>Splash</button>
      <button class="drydockbutton" onClick={contentDrawer}>Content Drawer</button>
      <button class="drydockbutton" onClick={footerDrawer}>Footer Drawer</button>
      <button class="drydockbutton" onClick={test}>Test</button>
      <button class="drydockbutton" onClick={test}>Test</button>
      <button class="drydockbutton" onClick={test}>Test</button>
      <button class="drydockbutton" onClick={test}>Test</button>
      <button class="drydockbutton" onClick={test}>Test</button>
    ...
    <div id="main" class="App font-Din">
      ...
      <div id="content" class="bcolor-grey90 tcolor-white flex-jC-aiC">
        <h1>Content</h1>
      </div>
